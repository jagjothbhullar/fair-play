...
export default function ProfileSetupModal({ userId, userEmail, onComplete, onSkip }: ProfileSetupModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-lg bg-zinc-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <div className="px-6 py-6">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-white/10">
              <p className="text-white/50 text-sm mb-3">Social Media <span className="text-white/30">(optional)</span></p>
              <div className="grid grid-cols-3 gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-6 pr-2 py-2 bg-black/30 border border-white/10 rounded-lg text-white placeholder-white/30 focus:outline-none focus:border-emerald-400/50 text-xs"
                  />
                </div>
                <div className="relative">
                  <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-white/30 text-xs">@</span>
        ...
        <div className="px-6 pb-6 space-y-3">
          <button
            ...
            disabled={saving}
            className="w-full py-3 bg-gradient-to-r from-emerald-400 to-emerald-500 text-black rounded-xl font-semibold hover:from-emerald-300 hover:to-emerald-400 disabled:opacity-50 transition-all"
          >
            {saving ? (
